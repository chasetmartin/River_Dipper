...
<Seomainnav 
title="About" 
description="We're a small team working to expand on the great work of the USGS, NOAA, and Rec.gov to build a next-generation application for river recreation & community." 
...
<div in:fade={{duration:600}} class="container">
    ...
    <hr class="!border-t-2" />
    <h3 class="p-4">Find the data you need, connect with other river lovers, and do it all ad-free!</h3>
    <hr />
</div>